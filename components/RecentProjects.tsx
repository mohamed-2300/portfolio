        ...
        {projects.map((item) => (
          ...
          >
            <PinContainer title={item.link} href={item.link}>
                <div className="relative flex items-center justify-center sm:w-80 w-[80vw] overflow-hidden h-[100px] lg:h-[170px] mb-10">
                  <div
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                <div className="flex items-center">
                  {item.iconLists.map((icon, index) => (
                    <div
                      key={index}
                      className="border border-white/[.2] rounded-full bg-[#00031a] lg:w-10 lg:h-10 w-8 h-8 flex justify-center items-center"
                      style={{
